...
public:
    ...
    void PDCGM_set_primal_lb(const int size, const double primal_lb){this->m_primal_lb = std::vector<double>(size,primal_lb);}

    void PDCGM_set_primal_lb(const std::vector<double>& primal_lb){this->m_primal_lb = primal_lb;}

    void PDCGM_set_primal_lb_fxd(const int size, const double primal_lb){this->m_primal_lb_fxd = std::vector<double>(size,primal_lb);}

    void PDCGM_set_primal_lb_fxd(const std::vector<double>& primal_lb){this->m_primal_lb_fxd = primal_lb;}

    void PDCGM_set_primal_ub(const int size, const double primal_ub){this->m_primal_ub = std::vector<double>(size,primal_ub);}

    void PDCGM_set_primal_ub(const std::vector<double>& primal_ub){this->m_primal_ub = primal_ub;}

    void PDCGM_set_primal_ub_fxd(const int size, const double primal_ub){this->m_primal_ub_fxd = std::vector<double>(size,primal_ub);}
